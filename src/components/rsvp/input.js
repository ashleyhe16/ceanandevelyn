...
import FormFooter from "./rsvp-form-footer";
      ...
      <div className="form__controls">
        ...
        <fieldset className="control__checkbox-fieldset">
          <legend className="control__checkbox-legend">
            Which events will this guest be attending?
          </legend>
          ...
          <div className="control__checkbox-group">
            ...
            <label className="control__checkbox-description" htmlFor="attend-1">
              <span className="control__checkbox-label">
                Ceremony & Brunch Reception
              </span>
              <br />
              <span className="control__checkbox-caption">
                11am, Queens Botanical Garden
              </span>
            </label>
          </div>
          ...
          <div className="control__checkbox-group">
            <input
              ...
              type="checkbox"
              id="attend-2"
              name="attendingBanquet"
              defaultChecked={props.attendingBanquetValue}
              onChange={props.handleChange}
            />
        ...
        <div className="control__textbox-group">
          ...
          <label
            ...
            htmlFor="dietaryRestrictions"
          >
            For example: vegetarian, seafood allergy, etc.
          </label>
          <input
            className="control__textbox-input"
            type="text"
